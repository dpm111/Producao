...
@Entity
@Table(name="arquivohistoricotransacoes")
public class ArquivoHistoricoTransacoes {
	
	


	public ArquivoHistoricoTransacoes( int idproduto, int idordemreferencia, int idlinhaordemreferencia,
	...
	protected ArquivoHistoricoTransacoes() {
	}
	...
	public String toString() {
		return "ArquivoHistoricoTransacoes [idtransacao=" + idtransacao + ", idproduto=" + idproduto + ", idordemreferencia="
